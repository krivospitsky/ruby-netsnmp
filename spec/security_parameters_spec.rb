...
RSpec.describe NETSNMP::SecurityParameters do
  ...
  describe "#passkey" do
    ...
    context "sha512" do
      ...
      it {
        expect(subject.send(:passkey,
                            password).b).to eq("~C\x96\xDEZ\xAD\xC7{\xE8S\x81\x9B\x98\xC9@be\xB3\xA9\xC3|\xC3\x17ei\x84zNOo\xBAc\xDD:s\xD0I$\xD3\x1Ac\xF9Z`" \
                                               "\x1F\x93\x85\xAFk\xE4\xED\e7\xF8}\x04\x0F|n\xD6\xF8\xD3\x8A\x91".b)
      }
    end
  end
  ...
  describe "keys" do
    ...
    it do
      ...
      expect(sha384_sec.send(:auth_key)).to eq(";)\x8F\x16\x16J\x11\x18By\xD5C+\xF1i\xE2\xD2\xA4\x83\a\xDE\x02\xB3\xD3\xF7\xE2\xB4\xF3n\xB6" \
                                               "\xF0EZSh\x9A97\xEE\xA0s\x19\xA63\xD2\xCC\xBAx".b)
      expect(sha384_sec.send(:priv_key)).to eq(";)\x8F\x16\x16J\x11\x18By\xD5C+\xF1i\xE2\xD2\xA4\x83\a\xDE\x02\xB3\xD3\xF7\xE2\xB4\xF3n\xB6" \
                                               "\xF0EZSh\x9A97\xEE\xA0s\x19\xA63\xD2\xCC\xBAx".b)
      expect(sha512_sec.send(:auth_key)).to eq("\"\xA5\xA3l\xED\xFC\xC0\x85\x80z\x12\x8D{\xC6\xC28!g\xADl\r\xBC_\xDF\xF8Vt\x0F=\x84\xC0\x99\xAD" \
                                               "\x1E\xA8z\x8D\xB0\x96qM\x97\x88\xBDT@G\xC9\x02\x1EB)\xCE'\xE4\xC0\xA6\x92P\xAD\xFC\xFF\xBB\v".b)
      expect(sha512_sec.send(:priv_key)).to eq("\"\xA5\xA3l\xED\xFC\xC0\x85\x80z\x12\x8D{\xC6\xC28!g\xADl\r\xBC_\xDF\xF8Vt\x0F=\x84\xC0\x99\xAD" \
                                               "\x1E\xA8z\x8D\xB0\x96qM\x97\x88\xBDT@G\xC9\x02\x1EB)\xCE'\xE4\xC0\xA6\x92P\xAD\xFC\xFF\xBB\v".b)
    end
  end
